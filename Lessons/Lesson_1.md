-- *Slide* --
### Goals for today
* Part 1: Parallel Computation and the Spartan HPC
* Part 2: File Transfers, Environment Modules, and Job Submission
* Part 3: R and Matlab with Job Scripts
* Part 4: Shell Scripts with Job Scripts
* A copy of the slides and source code is available at: https://github.com/UoM-ResPlat-DevOps/HPCEcons
-- *Slide End* --
